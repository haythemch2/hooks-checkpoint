...
function App() {
  ...
  const [searchcondition, setSearchcondition] = useState({name:'mov',rating:0})
  ...
  return (
    <div className="App">
      <NavMenu onChange={setPage} searchcondition={searchcondition} setSearchcondition={setSearchcondition} />
      {(page==='home')?<Cardcontainer list={moviesList} page={page} Conditionsearch={searchcondition}/>:<Inputform onChange={setPage} MoviesList={moviesList} setMovies={setMoviesList}/>};
    </div>
  );
}
